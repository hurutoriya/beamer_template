...
%% View
\usetheme{Malmoe} % Your favorite theme
\setbeamertemplate{footline}[frame number} % only page number in footer
...
\usepackage[footnotesize, bf]{caption} % footnote available
\newcommand{\argmin}{\mathop{\rm arg~min}\limits} % argmin available

%Beamer Color Setting
